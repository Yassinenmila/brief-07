<div class="bg-white p-8 rounded-xl shadow-lg w-full max-w-md">
        ...
        <form action="sign_up.php" method="POST" class="flex flex-col gap-4">
            <div>
                ...
                <input id="name" type="text" placeholder="Entrer votre nom" required class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>
            <div>
            ...
            <div>
                ...
                <input id="conf" type="password" placeholder="Confirmer votre mot de passe" required class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>
